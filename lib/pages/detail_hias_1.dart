...
class DetailHias1 extends StatelessWidget {
  const DetailHias1({super.key});
          ...
          Container(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text: ' Jagung membutuhkan air yang cukup, terutama saat fase pembentukan tongkol. Berikan air secara teratur, terutama saat tanaman masih muda dan selama periode kekeringan.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
                  ...
                  const TextSpan(
                    text: '2.Pemberian Pupuk: ',
                  ),
                  TextSpan(
                    text: 'Berikan pupuk secara teratur untuk memastikan tanaman mendapatkan nutrisi yang cukup. Pemupukan bisa dilakukan dengan pupuk organik atau pupuk kimia sesuai petunjuk dosisnya.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
                  ...
                  const TextSpan(
                    text: '3. Pengendalian Gulma:',
                  ),
                  TextSpan(
                    text: 'Bersihkan gulma secara teratur karena gulma dapat bersaing dengan tanaman jagung untuk mendapatkan nutrisi dan air.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
