    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(0.9*fem, 0*fem, 1.4*fem, 0.5*fem),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0.4*fem, 0*fem, 1.3*fem),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0.2*fem, 0*fem, 1.3*fem),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(0.3*fem, 0*fem, 0*fem, 0.2*fem),
                            child: SizedBox(
                              width: 6.3*fem,
                              height: 6.3*fem,
                              child: SvgPicture.asset(
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(0.5*fem, 0*fem, 0.4*fem, 0*fem),
                            child: Text(
                              'Mawar Putih',
                              style: GoogleFonts.getFont(
                                'Poppins',
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0.3*fem, 0*fem, 1.3*fem),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0.4*fem, 0*fem, 1.5*fem),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(0.9*fem, 0*fem, 1.4*fem, 2.1*fem),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.6*fem),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(0.4*fem, 0*fem, 0*fem, 0.4*fem),
                            child: SizedBox(
                              width: 6.3*fem,
                              height: 6.3*fem,
                              child: SvgPicture.asset(
