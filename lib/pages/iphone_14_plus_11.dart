...
class Iphone14Plus11 extends StatelessWidget {
  const Iphone14Plus11({super.key});
  ...
  double fem = MediaQuery.of(context).size.width / 428;
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(0*fem, 4.3*fem, 0*fem, 0*fem),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 2*fem, 9.1*fem),
              child: Align(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(18.2*fem, 0*fem, 0*fem, 5.1*fem),
              child: SizedBox(
                width: 2.5*fem,
                child: Container(
                  padding: EdgeInsets.fromLTRB(0.6*fem, 0.4*fem, 0*fem, 0*fem),
                  child: Stack(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0.1*fem, 0*fem, 0*fem, 17.6*fem),
              child: Container(
