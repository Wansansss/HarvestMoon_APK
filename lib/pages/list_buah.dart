    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.3*fem, 0*fem, 1.4*fem, 0.9*fem),
            decoration: BoxDecoration(
          ...
          Container(
            ...
            child: Container(
              padding: EdgeInsets.fromLTRB(0.7*fem, 0.8*fem, 1.4*fem, 1.1*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
          ...
          Container(
            ...
            child: Container(
              padding: EdgeInsets.fromLTRB(1*fem, 1.1*fem, 1.4*fem, 0.8*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.fromLTRB(0*fem, 1.5*fem, 0*fem, 2*fem),
                        child: Text(
                          'Durian',
                          style: GoogleFonts.getFont(
                            'Poppins',
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 0*fem, 1.5*fem),
                    width: 1.3*fem,
                    height: 2.5*fem,
                    child: SizedBox(
                      width: 1.3*fem,
