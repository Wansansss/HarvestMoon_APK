    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(0.9*fem, 0*fem, 0.8*fem, 5.1*fem),
            child: SizedBox(
              width: 25*fem,
              height: 8.1*fem,
              child: SvgPicture.asset(
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.3*fem, 0*fem, 1.3*fem, 3.3*fem),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.3*fem, 0*fem, 1.4*fem, 1.9*fem),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
