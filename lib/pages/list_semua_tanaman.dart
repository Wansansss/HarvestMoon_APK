...
class ListSemuaTanaman extends StatelessWidget {
  const ListSemuaTanaman({super.key});
    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.5*fem, 0*fem, 1.4*fem, 0.6*fem),
            child: Container(
              decoration: const BoxDecoration(
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.3*fem, 0*fem, 1.3*fem, 1.1*fem),
            decoration: BoxDecoration(
          ...
          Container(
            ...
            child: Container(
              padding: EdgeInsets.fromLTRB(0.6*fem, 0.9*fem, 1.4*fem, 0.9*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.fromLTRB(0*fem, 1.6*fem, 0*fem, 1.9*fem),
                        child: Text(
                          'Stroberi',
                          style: GoogleFonts.getFont(
                            'Poppins',
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 1.1*fem, 0*fem, 1.4*fem),
                    width: 1.3*fem,
                    height: 2.5*fem,
                    child: SizedBox(
                      width: 1.3*fem,
          ...
          Container(
            ...
            child: Container(
              padding: EdgeInsets.fromLTRB(0*fem, 2.1*fem, 1.4*fem, 2.3*fem),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 0.5*fem, 0.8*fem, 0.5*fem),
                    child: SizedBox(
                      width: 14.1*fem,
                      child: Text(
                        'Mangga',
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.3*fem, 0*fem, 1.4*fem, 0.4*fem),
            decoration: BoxDecoration(
              border: Border.all(color: const Color(0xFF16A34A)),
              borderRadius: BorderRadius.circular(0.3*fem),
              color: const Color(0xFFFFFFFF),
