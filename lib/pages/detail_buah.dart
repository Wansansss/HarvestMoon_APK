    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.4*fem, 0*fem, 1.4*fem, 2.1*fem),
            child: Align(
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.2*fem, 0*fem, 0.9*fem, 0.8*fem),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.2*fem, 0*fem, 2.3*fem, 1.9*fem),
            child: RichText(
              text: TextSpan(
                text: '1. Pemilihan Bibit',
                style: GoogleFonts.getFont(
                  'Poppins',
                  fontWeight: FontWeight.w600,
                  fontSize: 0.8*fem,
                ...
                children: [
                  TextSpan(
                    text: '- Pilih bibit stroberi yang berkualitas dari varietas unggul yang sesuai dengan iklim dan kondisi tanah di daerah Anda.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
                  ...
                  TextSpan(
                    text: '- Stroberi membutuhkan tanah yang subur, gembur, dan berdrainase baik.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.2*fem, 0*fem, 2.4*fem, 6.1*fem),
            child: RichText(
              text: TextSpan(
                text: '3. Penanaman',
                style: GoogleFonts.getFont(
                ...
                children: [
                  TextSpan(
                    text: '- Buat bedengan dengan lebar sekitar 1 meter dan tinggi 20-30 cm untuk mencegah genangan air.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
                  ...
                  TextSpan(
                    text: '- Siram tanaman setelah ditanam dan pastikan tanah tetap lembab, tetapi tidak tergenang air.',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w400,
                      fontSize: 0.8*fem,
